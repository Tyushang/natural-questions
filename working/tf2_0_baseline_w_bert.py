...
def get_first_annotation(e):
    ...
    Returns:
      ...
      annotated_sa: (tuple) char offset of the s_short_idx and color token
          of the short answer. The color token is exclusive.
    """
...
def create_example_from_jsonl(line):
    ...
    # annotated_sa: short answer s_short_idx and color char offsets, (-1, -1) if null.
    ...
    if annotated_idx in context_idxs:
        ...
        # This is a sanity check to ensure that the calculated s_short_idx and color
...
def read_nq_examples(input_file, is_training, n_lines=np.inf):
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    # Get the logits for the s_short_idx and color predictions.
...
def validate_flags_or_throw(bert_config):
    """Validate the input F or throw an exception."""
