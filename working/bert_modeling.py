...
class BertModel(tf.keras.layers.Layer):
  ...
  pooled_output, sequence_output = modeling.BertModel(bert_config=bert_config)(
  ...
  def get_config(self):
    config = {"bert_config": self.config.to_dict()}
...
class TransformerBlock(tf.keras.layers.Layer):
  ...
  def __init__(self,
    ...
    self.num_attention_heads = num_attention_heads
    self.intermediate_size = intermediate_size
    self.intermediate_activation = get_activation(
