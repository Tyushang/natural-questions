...
# !pip
# install - v - -no - cache - dir - -
# global
# -option = "--cpp_ext" - -
# global
# -option = "--cuda_ext".. / input / apex - master / apex /
# !pip
...
class BertForQuestionAnswering(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.qa_outputs = nn.Linear(config.hidden_size, 2)  # s_short_idx/color
    ...
    def forward(self, input_ids, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None):
        ...
        # predict s_short_idx & color position
